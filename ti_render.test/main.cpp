...
point_light_object* point_light_0_obj = nullptr;
...
void update() {
	...
	point_light_0_obj->set_local_position(light_pos);
...
int main(int, char**) {
	...
	point_light_0_obj = scene.create_point_light(glm::vec3(3.0f, 3.0f, 3.0f));
